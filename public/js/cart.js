    ...
    if (items.length === 0) {
      container.innerHTML = `
        <div class="text-center py-5">
          ...
          <a href="/products.html" class="btn btn-outline-gold btn-sm mt-2" data-bs-dismiss="modal">Explore Products</a>
        </div>
      `;
...
document.addEventListener('click', (e) => {
  ...
  // If checkoutSection is on page, smooth scroll towards it
